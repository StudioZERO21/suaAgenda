...
<style>
    ...
    .sa-site-field { width:100%; padding:9px 12px; font-size:13px; border:1.5px solid var(--sa-border); border-radius:8px; background:var(--sa-surface); color:var(--sa-text1); outline:none; box-sizing:border-box; font-family:var(--sa-font-body); transition:border-color 160ms; }
    .sa-site-field:focus { border-color:var(--sa-primary); }
    .sa-site-label { font-size:13px; font-weight:600; color:var(--sa-text1); display:block; margin-bottom:6px; }
            ...
            <div>
                ...
                <div x-show="tab === 'banner'" x-cloak style="display:flex;flex-direction:column;gap:20px">
                    ...
                    <x-sa.card style="padding:22px">
                        ...
                        <div class="sa-site-dropzone" @click="uploadHint('Upload de banner em breve!')">
                ...
                <div x-show="tab === 'seo'" x-cloak style="display:flex;flex-direction:column;gap:20px">
                    ...
                    <x-sa.card style="padding:22px">
                        ...
                        <div class="sa-site-dropzone sa-site-dropzone--sm" @click="uploadHint('Upload em breve!')">
                            ...
                            <div style="font-size:13px;color:var(--sa-text3)">Recomendado: 1200×630px</div>
                        </div>
                    </x-sa.card>
