...
<div style="max-width:680px">
    <div style="display:flex;align-items:center;gap:14px;margin-bottom:24px">
        ...
        <div>
            <h1 style="font-family:'Poppins',sans-serif;font-size:20px;font-weight:700;color:var(--sa-text1);margin:0 0 2px">Novo Serviço</h1>
        ...
        <form method="POST" action="{{ route('servicos.store') }}" style="display:flex;flex-direction:column;gap:18px">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
                ...
                <div style="grid-column:1/-1">
                    ...
                    <textarea name="descricao" rows="2" placeholder="Descrição opcional do serviço"
                              ...
                              onfocus="this.style.borderColor='var(--sa-secondary)'" onblur="this.style.borderColor='var(--sa-border)'">{{ old('descricao') }}</textarea>
                </div>
            </div>
            ...
            <div>
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:8px">
                    ...
                    <label style="display:flex;align-items:center;gap:8px;padding:10px 12px;border:1.5px solid var(--sa-border);border-radius:9px;cursor:pointer;transition:border-color 150ms" onmouseover="this.style.borderColor='var(--sa-secondary)'" onmouseout="this.style.borderColor='var(--sa-border)'">
